...
from distributed.channels import ChannelScheduler
from distributed.recreate_exceptions import ReplayExceptionScheduler
...
def main(host, port, http_port, bokeh_port, bokeh_internal_port, show, _bokeh,
    ...
    scheduler = Scheduler(loop=loop, services=services,
                          ...
                          extensions=[ChannelScheduler, PublishExtension, ReplayExceptionScheduler])
